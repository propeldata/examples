...
export default function SSR({ propelData }) {
    ...
    const percentDifference = `${decimalDifference>0?"+":""}${Math.round(10000*decimalDifference)/100}`
            ...
            <Row style={{padding:5}}>
                ...
                <Col md={6} style={{display:'flex', justifyContent:'right', padding:10, backgroundColor: '#464646'}}>
                    <Dropdown>
                        ...
                        <Dropdown.Menu >
                            <Dropdown.Item href="/counter?timeRange=TODAY&comparisonTimeRange=YESTERDAY">Today</Dropdown.Item>
                            <Dropdown.Item href="/counter?timeRange=THIS_WEEK&comparisonTimeRange=PREVIOUS_WEEK">This Week</Dropdown.Item>
                            <Dropdown.Item href="/counter?timeRange=THIS_MONTH&comparisonTimeRange=PREVIOUS_MONTH">This Month</Dropdown.Item>
                            <Dropdown.Item href="/counter?timeRange=THIS_YEAR&comparisonTimeRange=PREVIOUS_YEAR">This Year</Dropdown.Item>
                            </Dropdown.Menu>
                    </Dropdown>
                </Col>
            </Row>
...
export async function getServerSideProps(context) {
    ...
    const timeSeriesQuery = gql`
        query timeSeries ($uniqueName: String!, $timeRange: TimeRangeInput!, $comparisonTimeRange: TimeRangeInput!) {
            metricByName(uniqueName: $uniqueName) {
                mainCounter: counter (input: {
                    timeRange: $timeRange
                    }) {
                        value
                    }
                comparisonCounter: counter (input: {
